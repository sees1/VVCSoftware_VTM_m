...
multiple matches.
\\
\Option{AlfSaoTrueOrg} &
%\ShortOption{\None} &
\Default{false} &
When GOP based temporal filter is enabled, enable or disable using true original samples for ALF and SAO optimization .
\\
\end{OptionTableNoShorthand}
...
MaxCuDQPSubdiv is preferably set to 1 or 2 to achieve best subjective performance.
\\
