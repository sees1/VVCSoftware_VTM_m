...
for the VVC project. It applies to version 15.1 of the software.
\end{abstract}
...
%\ShortOption{\None} &
\Default{0} &
Number of past frames used by the temporal filter. If TemporalFilterPastRefs and TemporalFilterFutureRefs are 0, the filter is
disabled.
\\
\Option{TemporalFilterFutureRefs} &
%\ShortOption{\None} &
\Default{0} &
Number of future frames used by the temporal filter.
\\
