...
\Default{1} &
Number of sublayers in context of the SEI. Has to be no greater than vps_max_sublayers_minus1 + 1.
\\
\Option{SEISubpicLevelInfoSublayerInfoPresentFlag} &
\Default{0} &
The level information for subpicture sequences is present for sublayer representation(s).
\par
\begin{tabular}{cp{0.45\textwidth}}
1 & The level information for subpicture sequences is present for sublayer representation(s) in the range of 0 to sli_max_sublayers_minus1, inclusive. \\
